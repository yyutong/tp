...
//        Expense expectedExpense = new ExpenseBuilder(BOOKS).withCategory(VALID_CATEGORY_BOOKS).build();
//
...
//        // zero tags
//        Expense expectedPerson = new ExpenseBuilder(BOOKS).withAmount(null).build();
